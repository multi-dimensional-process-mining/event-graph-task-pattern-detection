from labelmakers.GeneralLabelMaker import LabelMaker
...
def get_label_maker(name_data_set, use_label_dict=False, activity_label="activity", print_duration=False,
    ...
    if name_data_set == "bpic2017":
        ...
        return BPIC2014LabelMaker(use_label_dict=use_label_dict, activity_label=activity_label,
                                  print_duration=print_duration, activity_label_sep=activity_label_sep)

    else:
        return LabelMaker(activity_label=activity_label, print_duration=print_duration,
